...
def javaVersion = "MAVEN_339_JDK_11_OPENJ9"
...
def aksRG = "RSGREU2QTECHBP01"
//for AKS Cluster Name, for anything else: def aksCluster = ""
def aksCluster = "AKSREU2QTECHBP01"
//Ingress information for AKS
def ingressFQDN = "azingressqtechprod.perzet.com"
def ingressCertificateSecret = "azingressqtechprod-cert"
//registry for AKS
def registry = "azingressqtechprod.azurecr.io"
try {
    node {
        stage('Preparation') {
            ...
            utils.setHashicorpVaultNamespace("QTECH")
