...
def aksRG = "RSGREU2QTECHBC01"
//for AKS Cluster Name, for anything else: def aksCluster = ""
def aksCluster = "AKSREU2QTECHBD01"
//Ingress information for AKS
def ingressFQDN = "azingressqtechcer.perzet.com"
def ingressCertificateSecret = "azingressqtechcer-cert"
//registry for AKS
def registry = "azingressqtechcer.azurecr.io"
try {
    node {
        stage('Preparation') {
